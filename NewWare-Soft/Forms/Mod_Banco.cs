...
namespace NewWare_Soft.Forms
{
    public partial class Mod_Banco : Form
    {
        ...
        private void CargarGrilla()
        {
            try
            {
                gdrBancos.DataSource = AD_Bancos.ObtenerListaBancos();
            }
            catch (Exception ex)
            {
        ...
        private void btnGuardarBanco_Click(object sender, EventArgs e)
        {
            try
            {
                AD_Bancos.ActualizarNombreBanco(IdBanco, txtNombreBanco.Text);
        ...
        private void btnBuscarBanco_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    Banco b = AD_Bancos.ObtenerBanco(nombreABuscar);
